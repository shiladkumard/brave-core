...
class DomainBlockingTest : public AdBlockServiceTest {
 public:
  DomainBlockingTest() {}
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(DomainBlockingTest);
};

IN_PROC_BROWSER_TEST_F(DomainBlockingTest, ShowInterstitial) {
  ...
  // interrupted by the domain blocked interstitial.
  BlockDomainByURL(url);
  NavigateTo(url);
  ASSERT_TRUE(IsShowingInterstitial());
}

IN_PROC_BROWSER_TEST_F(DomainBlockingTest, ShowInterstitialAndProceed) {
  ASSERT_TRUE(InstallDefaultAdBlockExtension());
  GURL url = embedded_test_server()->GetURL("a.com", "/simple.html");
...
IN_PROC_BROWSER_TEST_F(DomainBlockingTest, ShowInterstitialAndReload) {
  ASSERT_TRUE(InstallDefaultAdBlockExtension());
  GURL url = embedded_test_server()->GetURL("a.com", "/simple.html");
...
IN_PROC_BROWSER_TEST_F(DomainBlockingTest, ProceedAndReload) {
  ASSERT_TRUE(InstallDefaultAdBlockExtension());
  GURL url = embedded_test_server()->GetURL("a.com", "/simple.html");
...
IN_PROC_BROWSER_TEST_F(DomainBlockingTest, ProceedDoesNotAffectNewTabs) {
  ASSERT_TRUE(InstallDefaultAdBlockExtension());
  GURL url = embedded_test_server()->GetURL("a.com", "/simple.html");
  ...
  // by the domain blocked interstitial, because the permission we gave by
...
IN_PROC_BROWSER_TEST_F(DomainBlockingTest, DontWarnAgainAndProceed) {
  ASSERT_TRUE(InstallDefaultAdBlockExtension());
  GURL url = embedded_test_server()->GetURL("a.com", "/simple.html");
...
IN_PROC_BROWSER_TEST_F(DomainBlockingTest, ShowInterstitialAndGoBack) {
  ASSERT_TRUE(InstallDefaultAdBlockExtension());
